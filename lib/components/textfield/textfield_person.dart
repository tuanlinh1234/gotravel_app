...
class MyTextFieldPerson extends StatefulWidget {
  ...
  @override
  State<MyTextFieldPerson> createState() => _MyTextFieldPersonState();
}

class _MyTextFieldPersonState extends State<MyTextFieldPerson> {
  @override
