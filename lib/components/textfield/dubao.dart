...
class MyTextFielWeather extends StatefulWidget {
  ...
  @override
  State<MyTextFielWeather> createState() => _MyTextFielWeatherState();
}

class _MyTextFielWeatherState extends State<MyTextFielWeather> {
  @override
