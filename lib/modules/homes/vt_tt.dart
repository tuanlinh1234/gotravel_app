...
//     final url = Uri.parse('$apiEndpoint?lat=${position.latitude}&lon=${position.longitude}&appid=$apiKey&units=metric');
...
//           children: [
//             if (_iconUrl != null) Image.network(
//               _iconUrl!,
//               height: 150.0,
//               width: 150.0,
//               fit: BoxFit.cover,
...
//               child: const Text('Lấy dữ liệu thời tiết ở vị trí hiện tại'),
//             ),
//           ],
//         ),
//       ),
