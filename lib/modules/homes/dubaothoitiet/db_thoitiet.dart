...
const apiKey =
    '62b56bca98de2c469978f73cb8abfde5';
...
class _WeatherForecastState extends State<WeatherForecast> {
  ...
  Future<void> _fetchWeatherData() async {
    final url = Uri.parse(
        '$apiEndpoint?q=Ho%20Chi%20Minh&appid=$apiKey&units=metric');
  ...
  Future<void> _fetchWeatherDatas(String city) async {
    final url = Uri.parse(
